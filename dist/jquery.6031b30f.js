  ...
  return {
    ...
    find: function find(selector) {
      ...
      for (var i = 0; i < elements.length; i++) {
        var eles2 = Array.from(elements[i].querySelectorAll(selector));
        array = array.concat(eles2);
      }
      array.oldApi = this;
      return jQuery(array);
    },
    ...
    parent: function parent() {
      ...
      this.each(function (node) {
        if (!array.includes(node.parentNode)) {
    ...
    children: function children() {
      var array = [];
      this.each(function (node) {
        return array.push.apply(array, _toConsumableArray(node.children));
      });
      return jQuery(array);
    },
...
},{}]},{},["../../../../../usr/local/share/.config/yarn/global/node_modules/parcel/src/builtins/hmr-runtime.js","jquery.js"], null)
//# sourceMappingURL=/jquery.6031b30f.map